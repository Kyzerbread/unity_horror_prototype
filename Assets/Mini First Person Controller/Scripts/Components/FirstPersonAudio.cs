...
public class FirstPersonAudio : MonoBehaviour
{
    ...
    Vector2 CurrentCharacterPosition => new Vector2(controller.transform.position.x, controller.transform.position.z);
    ...
    void Update()
    {
        ...
        if (speed >= velocityThreshold && controller.isGrounded)
        {
            //if (crouch)
            //{
